...
class SockPage extends StatefulWidget {
  @override
  State<SockPage> createState() => _SockPageState();
}

class _SockPageState extends State<SockPage> {
  List<Shoe> shoes = [];
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: (shoes.length >= 12) ? 6 : (shoes.length - 6), // Adjusted itemCount
              scrollDirection: Axis.horizontal,
              itemBuilder: (context, index) {
                Shoe shoe = shoes[index + 6]; // Adjusted index
                return ShoeTile(
                  shoe: shoe,
